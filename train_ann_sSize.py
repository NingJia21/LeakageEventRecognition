...
feature_x1 = pd.read_csv(r'D:\phi_OTDR\24_2_Tdata\Tdata_x.csv', sep=',', header=None)
feature_x2 = pd.read_csv(r'D:\phi_OTDR\24_2_Tdata\Tdata_lean.csv', sep=',', header=None)
feature_x3 = pd.read_csv(r'D:\phi_OTDR\24_2_Tdata\Tdata_disturb.csv', sep=',', header=None)
