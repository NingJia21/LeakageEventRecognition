...
data_x1 = pd.read_csv(r'D:\phi_OTDR\3_TrainData\Data\ANNData_xf.csv', sep=',', header=None)
data_y1 = pd.read_csv(r'D:\phi_OTDR\3_TrainData\Data\ANNData_yf.csv', sep=',', header=None)

data_x2 = pd.read_csv(r'D:\phi_OTDR\3_TrainData\Data\ANNData_lean.csv', sep=',', header=None)
data_y2 = pd.read_csv(r'D:\phi_OTDR\3_TrainData\Data\ANNData_lean_y.csv', sep=',', header=None)

data_x3 = pd.read_csv(r'D:\phi_OTDR\3_TrainData\Data\ANNData_disturb.csv', sep=',', header=None)
data_y3 = pd.read_csv(r'D:\phi_OTDR\3_TrainData\Data\ANNData_disturb_y.csv', sep=',', header=None)
