...
data_x1 = pd.read_csv(r'D:\phi_OTDR\3_TrainData\Data\ANNData_xf_test.csv', sep=',', header=None)
data_y1 = pd.read_csv(r'D:\phi_OTDR\3_TrainData\Data\ANNData_yf_test.csv', sep=',', header=None)

data_x2 = pd.read_csv(r'D:\phi_OTDR\3_TrainData\Data\ANNData_lean_test.csv', sep=',', header=None)
data_y2 = pd.read_csv(r'D:\phi_OTDR\3_TrainData\Data\ANNData_lean_test_y.csv', sep=',', header=None)

data_x3 = pd.read_csv(r'D:\phi_OTDR\3_TrainData\Data\ANNData_disturb_test.csv', sep=',', header=None)
data_y3 = pd.read_csv(r'D:\phi_OTDR\3_TrainData\Data\ANNData_disturb_test_y.csv', sep=',', header=None)

data_x4 = pd.read_csv(r'D:\phi_OTDR\3_TrainData_feature_test\feature_expend\test.csv', sep=',', header=None)
...
data_x12 = data_x1.iloc[200:250, :]
data_y12 = data_y1.iloc[200:250]
